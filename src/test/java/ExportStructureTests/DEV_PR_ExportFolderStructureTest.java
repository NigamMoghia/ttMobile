...
/**
 * Created by RGupta on 12/19/2017.
 */
public class DEV_PR_ExportFolderStructureTest {
    File file = null;
    GetXSDsFromAccurev xsDsFromAccurev ;
    @BeforeClass
    public void setUp() throws Exception{
        file = GetterClass.getWindowsExportFolderPath("DEV","PR");
        xsDsFromAccurev = new GetXSDsFromAccurev("DEV");
